      ...
      <motion.div
        ...
        <div className="landing-left w-1/2">
          ...
          <div className="socials">
            <a
              href="https://www.linkedin.com/in/ahmad-fadhil-naswir-47434ab1/"
              target="_blank"
            ...
            <a href="https://github.com/afadhilen" target="_blank" rel="noopener noreferrer">
              <button className="btn btn-circle btn-outline mx-1 my-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
            ...
            <a
              href="mailto:afadhilenproject@gmail.com?subject=Support%20Inquiry&body=Hello%20Support%2C%0A%0AI%20have%20a%20question%20regarding..."
              target="_blank"
              rel="noopener noreferrer">
              <button className="btn btn-circle btn-outline mx-1 my-1">
                <svg
            ...
            <a href="https://instagram.com/memoaraku" target="_blank" rel="noopener noreferrer">
              <button className="btn btn-circle btn-outline mx-1 my-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
